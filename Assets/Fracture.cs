...
{
    public float breakRadius = 0.2f; // radius wich a collision affect any cells
    public float breakForce = 100; // force required to break the wall
    ...
    public void FractureFonction(Vector3 point, Vector3 force)
    {
        foreach (SubFracture cell in cells)
        {
